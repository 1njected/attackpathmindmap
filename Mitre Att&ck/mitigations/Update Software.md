...
| ID | Name | Description |
| --- | --- | --- |
| [[Pass the Hash\|T1550.002]] | Pass the Hash | Apply patch KB2871997 to Windows 7 and higher systems to limit the default access of accounts in the local administrator group.(Citation: NSA Spotting)  |
| [[Unsecured Credentials\|T1552]] | Unsecured Credentials | Apply patch KB2962486 which prevents credentials from being stored in GPPs.(Citation: ADSecurity Finding Passwords in SYSVOL)(Citation: MS14-025) |
| [[Bypass User Account Control\|T1548.002]] | Bypass User Account Control | Consider updating Windows to the latest version and patch level to utilize the latest protective measures against UAC bypass.(Citation: Github UACMe) |
| [[DLL Side-Loading\|T1574.002]] | DLL Side-Loading | Update software regularly to include patches that fix DLL side-loading vulnerabilities. |
| [[SNMP (MIB Dump)\|T1602.001]] | SNMP (MIB Dump) | Keep system images and software updated and migrate to SNMPv3.(Citation: Cisco Blog Legacy Device Attacks) |
...
| [[Password Managers\|T1555.005]] | Password Managers | Update password managers regularly by employing patch management for internal enterprise endpoints and servers. |
...
| [[Data from Configuration Repository\|T1602]] | Data from Configuration Repository | Keep system images and software updated and migrate to SNMPv3.(Citation: Cisco Blog Legacy Device Attacks) |
| [[Drive-by Compromise\|T1189]] | Drive-by Compromise | Ensure all browsers and plugins kept updated can help prevent the exploit phase of this technique. Use modern browsers with security features turned on. |
| [[Exploitation for Defense Evasion\|T1211]] | Exploitation for Defense Evasion | Update software regularly by employing patch management for internal enterprise endpoints and servers. |
...
| [[Browser Extensions\|T1176]] | Browser Extensions | Ensure operating systems and browsers are using the most current version.  |
...
| [[Group Policy Preferences\|T1552.006]] | Group Policy Preferences | Apply patch KB2962486 which prevents credentials from being stored in GPPs.(Citation: ADSecurity Finding Passwords in SYSVOL)(Citation: MS14-025) |
...
| [[Network Device Configuration Dump\|T1602.002]] | Network Device Configuration Dump | Keep system images and software updated and migrate to SNMPv3.(Citation: Cisco Blog Legacy Device Attacks) |
